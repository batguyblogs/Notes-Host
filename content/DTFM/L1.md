...
modified: 2026-07-27T21:37:40.524+05:30
tags:
  - ClassNotes
cssclasses: ""
---
...
1. Physical Object / process
2. Virtual Model
3. The connection

##### Any digital twin can be divided into three fundamental parts, 

1. the physical object **the engine** and is real world asset with sensors and actuators

2. the virtual Model, it is  a combination of geometric model a physics based behaviour and AI model, that mimics the asset behaviour

3. the connection , it is the data pipeline them for synchronisation and control
